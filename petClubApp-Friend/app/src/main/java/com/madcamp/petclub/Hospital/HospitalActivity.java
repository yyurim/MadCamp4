package com.madcamp.petclub.Hospital;
...
public class HospitalActivity extends AppCompatActivity
    ...
    FloatingActionButton fab, fabHospital, fabPetCafe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayout = findViewById(R.id.layout_hospital);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( HospitalActivity.this, REQUIRED_PERMISSIONS,
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_home:
                intent = new Intent(HospitalActivity.this, MainActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_myCompanion:
                intent = new Intent(HospitalActivity.this, MyPetActivity.class);
                startActivityForResult(intent, 1);
                break;
            case R.id.nav_friends:
                intent = new Intent(HospitalActivity.this, SplashActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_board:
                intent = new Intent(HospitalActivity.this, BoardActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_share:
                intent = new Intent(HospitalActivity.this, NewsActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_hospital_info:
                break;
            case R.id.nav_myInfo:
                intent = new Intent(HospitalActivity.this, MyInfoActivity.class);
                startActivity(intent);
                break;
        }
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(HospitalActivity.this)
                .key("AIzaSyB68JIlqv8m4gPr8IoSzoyGAL2V4iya3GA")
